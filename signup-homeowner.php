...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] === 'register') {
        ...
        $phone = $_POST['phone'] ?? '';
        $user_type = 'homeowner'; // Fixed for homeowner signup
...
<head>
    ...
    <title>Sign Up as Homeowner - MoveMigo</title>
...
<body>
    ...
    <div class="signup-container">
        <img src="Vintage Property Owner Logo.png" alt="Vintage Property Owner Logo" class="vintage-logo">

        <div class="header">
            <h1>Join MoveMigo</h1>
            <p>Create your homeowner account</p>
            <div class="role-badge">Homeowner</div>
        </div>
